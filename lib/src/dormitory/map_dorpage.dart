...
class MapDoyPage extends StatefulWidget {
  @override
  State<MapDoyPage> createState() =>MapDoyPageState();
}

class MapDoyPageState extends State<MapDoyPage> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(33.56556393843793, 73.15440933381682), //TSU
      LatLng(6.882214812978835, 101.24149407759982), //Jittavet
      LatLng(6.880229018562126, 101.24152985855494), //Pongsin Co.th
      LatLng(-6.461695316134778, 106.85054458555108), //Songkhla Zoo
