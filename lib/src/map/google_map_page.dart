...
class GoogleMapPageState extends State<GoogleMapPage> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(13.683185370617437, 100.54729004364339), //TSU
      LatLng(13.415848794855927, 101.0242144870895), //Jittavet
      LatLng(13.459633145081275, 101.01735399045248), //Pongsin Co.th
      LatLng(13.713870506041287, 100.4194315300313), //Songkhla Zoo
