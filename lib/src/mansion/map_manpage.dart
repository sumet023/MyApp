...
class MapManPage extends StatefulWidget {
  @override
  State<MapManPage> createState() =>MapManPageState();
}

class MapManPageState extends State<MapManPage> {
  ...
  Future<void> _dummyLoction() async {
    ...
    List<LatLng> data = [
      LatLng(13.813609358934116, 100.4505910724318), //TSU
      LatLng(12.955029297569903, 100.9011615284455), //Jittavet
      LatLng(7.007773558793006, 100.48006627221645), //Pongsin Co.th
      LatLng(7.008932309570723, 100.48406741442177), //Songkhla Zoo
